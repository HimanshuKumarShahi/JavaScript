...
let total= products.reduce((prv,cur)=>{
    console.log(`${cur.name} _and_ ${cur.category}____ ${cur.quantity}:-_ ${cur.price} quantity:- ${cur.quantity}`);
    console.log("---------------------------");
    
    console.log(`quantity:- ${cur.quantity} and price:- ${cur.price} and final is :- ${(cur.price * cur.quantity)}`);
    console.log('------------------------------');
...
console.log(`The gramd Total ₹ ${total}`);clearInterval
=======
...
>>>>>>> 3877a89e75accb2b4d4757b9debda574a76119e2
